  ...
  return (
    <nav className="bg-gray-900 text-white p-4 shadow-lg sticky top-0 z-50 w-full">
      <div className="container mx-auto flex justify-between items-center">
        ...
        {/* Desktop Menu - Visible Contact Links with Text */}
        <div className="hidden md:flex space-x-6 items-center">
          <Link href="/movies" className="text-white hover:text-emerald-400 transition-colors font-medium">
            Agasobanuye
          </Link>

           <Link href="/english-version" className="text-white hover:text-emerald-400 transition-colors font-medium">
            Original Movies
          </Link>
          ...
          {/* Visible Contact Links with Text */}
          <a
            href="mailto:myhobbies@gmail.com"
            className="flex items-center gap-2 text-white hover:text-emerald-400 transition-colors font-medium"
          >
            <FaEnvelope className="text-emerald-400" />
            <span className="hidden lg:inline">myhobbies@gmail.com</span>
          </a>
          <a
            href="tel:+250736781948"
            className="flex items-center gap-2 text-white hover:text-emerald-400 transition-colors font-medium"
          >
            <FaPhone className="text-emerald-400" />
            <span>+250 736 781 948</span>
          </a>
          <a
            href="https://whatsapp.com/channel/0029Vb6rsTmGufIse0MGrx3g"
            target="_blank"
      ...
      {isOpen && (
        <div className="md:hidden bg-gray-800 px-4 pt-2 pb-4 space-y-2">
          ...
          {/* Mobile Contact Options with Text */}
          <div className="pt-2 border-t border-gray-700">
            <p className="text-gray-400 text-sm py-2">Contact Us:</p>
            <a
              href="mailto:myhobbies@gmail.com"
              className="flex items-center gap-3 text-white hover:text-emerald-400 transition-colors py-2"
              onClick={() => setIsOpen(false)}
            >
              <FaEnvelope className="text-emerald-400" />
              myhobbies@gmail.com
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 text-white hover:text-green-400 transition-colors py-2"
              onClick={() => setIsOpen(false)}
            >
              <FaWhatsapp className="text-green-400" />
              WhatsApp Channel
