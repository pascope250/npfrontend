                          ...
                          <div className="py-1">
                            ...
                            {currentMovie?.source.map((source, index) => (
                              <button
                                ...
                                className={`flex items-center w-full text-left px-3 py-2.5 text-sm text-gray-300 hover:bg-gray-700/50 transition-colors duration-150 cursor-pointer hover:text-white ${
